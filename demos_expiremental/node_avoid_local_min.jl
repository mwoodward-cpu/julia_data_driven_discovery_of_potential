...
#this iterative learning processes takes small chunks in time and learns each
#ode consectively reconstructing F in a consective manner.

#This could be useful for long time integrations but it may be a bit slow.
